...
nixops ssh rs-bank -- rscoin-bank --log-severity Debug --secret-key /var/lib/rscoin-bank/.rscoin/bankKey --config-path \$RSCOIN_CONFIG add-explorer --key $explorerKey --host $explorerHost --port $NIXOPS_EXPLORER_PORT
